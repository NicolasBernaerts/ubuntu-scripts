...
wget -4 -O $HOME/.local/share/nautilus-python/extensions/image-convert-menu.py https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/image/image-convert-menu.py
