...
# install icons
sudo wget -4 -O /usr/share/icons/image-resize.png https://raw.githubusercontent.com/NicolasBernaerts/icon/refs/heads/master/image/image-resize.png

# main script installation
sudo wget -4 -O /usr/local/bin/image-convert https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/image/image-convert
sudo chmod +x /usr/local/bin/image-convert

# desktop integration
mkdir --parents $HOME/.local/share/nautilus-python/extensions
wget -4 -O $HOME/.local/share/nautilus-python/extensions/image-resize-menu.py https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/image/image-resize-menu.py
