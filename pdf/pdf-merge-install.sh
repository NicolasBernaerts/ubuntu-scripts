...
# install icons
sudo wget -O /usr/share/icons/pdf-generate.png https://raw.githubusercontent.com/NicolasBernaerts/icon/refs/heads/master/pdf/pdf-merge.png

# main script installation
sudo wget -O /usr/local/bin/pdf-merge https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/pdf/pdf-merge
sudo chmod +x /usr/local/bin/pdf-merge

# desktop integration
mkdir --parents $HOME/.local/share/nautilus-python/extensions
wget -O $HOME/.local/share/nautilus-python/extensions/pdf-merge-menu.py https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/pdf/pdf-merge-menu.py
