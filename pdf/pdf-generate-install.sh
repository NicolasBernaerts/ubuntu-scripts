...
sudo apt -y install imagemagick unoconv ghostscript zenity libfile-mimeinfo-perl wkhtmltopdf
...
# install icons
sudo wget -O /usr/share/icons/pdf-generate.png https://github.com/NicolasBernaerts/ubuntu-scripts/raw/master/pdf/icons/pdf-generate.png
