...
do
	...
	sudo wget -4 -O "${ROOT_DOCTYPE}/lo-${DOCTYPE}.png" "https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/thumbnailer/libreoffice/icons/lo-${DOCTYPE}.png"
...
# install main script
sudo wget -4 -O /usr/local/sbin/lo-thumbnailer https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/thumbnailer/libreoffice/lo-thumbnailer
sudo chmod +rx /usr/local/sbin/lo-thumbnailer

# thumbnailer integration
sudo wget -4 -O /usr/share/thumbnailers/lo.thumbnailer https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/thumbnailer/libreoffice/lo.thumbnailer
