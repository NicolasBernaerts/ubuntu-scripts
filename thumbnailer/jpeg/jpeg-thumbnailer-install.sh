...
sudo wget -4 -O /usr/local/sbin/jpeg-thumbnailer https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/thumbnailer/jpeg/jpeg-thumbnailer
sudo chmod +rx /usr/local/sbin/jpeg-thumbnailer

# thumbnailer integration
sudo wget -4 -O /usr/share/thumbnailers/jpeg.thumbnailer https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/thumbnailer/jpeg/jpeg.thumbnailer
...
sudo wget -4 -O "${ROOT_ICON}/none.png" "https://github.com/NicolasBernaerts/icon/raw/refs/heads/master/camera/none.png"
...
sudo wget -4 -O "${ROOT_ICON}/gps.png" "https://github.com/NicolasBernaerts/icon/raw/refs/heads/master/camera/gps.png"
...
do
	...
	sudo wget -4 -O "${ROOT_ICON}/${ICON}.png" "https://github.com/NicolasBernaerts/icon/raw/refs/heads/master/camera/${ICON}.png"
