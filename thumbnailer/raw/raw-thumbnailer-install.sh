...
# install main script
sudo wget -4 -O /usr/local/sbin/raw-thumbnailer https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/thumbnailer/raw/raw-thumbnailer
sudo chmod +x /usr/local/sbin/raw-thumbnailer

# thumbnailer integration
sudo wget -4 -O /usr/share/thumbnailers/raw.thumbnailer https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/thumbnailer/raw/raw.thumbnailer
