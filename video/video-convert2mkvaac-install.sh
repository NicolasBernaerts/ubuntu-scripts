...
# install icons
sudo wget -4 -O /usr/share/icons/video-aac.png https://github.com/NicolasBernaerts/icon/raw/refs/heads/master/video/video-aac.png

# install configuration file
mkdir --parents $HOME/.config
wget -4 -O $HOME/.config/video-convert2mkvaac.conf https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/video/video-convert2mkvaac.conf

# install main script
sudo wget -4 -O /usr/local/bin/video-convert2mkvaac https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/video/video-convert2mkvaac
...
wget -4 -O $HOME/.local/share/nautilus-python/extensions/video-convert2mkvaac-menu.py https://github.com/NicolasBernaerts/ubuntu-scripts/raw/refs/heads/master/video/video-convert2mkvaac-menu.py
